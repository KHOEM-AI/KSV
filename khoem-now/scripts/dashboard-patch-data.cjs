// Plain CommonJS mirror of src/i18n/dashboard.i18n.ts's DASHBOARD_PATCH,
// so merge-dashboard-i18n.cjs can require() it without a TS build step.
// Keep this in sync with dashboard.i18n.ts if you edit either one.
