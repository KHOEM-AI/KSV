...
const T = {
  unlockTitle: "សោចុងក្រោយ",
  faceButton: "ស្កេនមុខ",
  usePattern: "ប្រើគូសដៃជំនួស",
  drawHint: "គូសលំនាំលើចំណុចទាំង 9",
  setupTitle: "កំណត់សោគូសដៃ",
  setupDraw: `គូសលំនាំថ្មី (យ៉ាងតិច ${MIN_PATTERN_DOTS} ចំណុច)`,
  setupConfirm: "គូសម្តងទៀតដើម្បីបញ្ជាក់",
  tooShort: `ត្រូវភ្ជាប់យ៉ាងតិច ${MIN_PATTERN_DOTS} ចំណុច`,
  mismatch: "មិនដូចគ្នា សូមចាប់ផ្តើមម្តងទៀត",
  wrong: "លំនាំមិនត្រូវ",
  locked: (s: number) => `ព្យាយាមខុសច្រើនពេក សូមរង់ចាំ ${s} វិនាទី`,
  faceFail: "ស្កេនមុខមិនបានជោគជ័យ សូមគូសលំនាំជំនួស",
  needSecure: "ត្រូវការ HTTPS ឬ localhost ដើម្បីប្រើសោនេះ",
  faceOfferTitle: "បើកការស្កេនមុខ?",
  faceOfferBody: "ទូរស័ព្ទរបស់អ្នកផ្ទៀងផ្ទាត់មុខដោយខ្លួនឯង KSV មិនឃើញ ឬរក្សារូបមុខឡើយ។",
  enable: "បើក",
  skip: "រំលង",
  forgot: "ភ្លេចលំនាំ?",
};
