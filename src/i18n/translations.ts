...
const km: Dict = {
  ...
  'view.audit.subtitleText': "កំណត់ត្រាព្រឹត្តិការណ៍ដែលបានចាក់សោគ្នាដោយគ្រីបតូ — សកម្មភាពទាំងអស់នៃវេទិកា",
  ...
  'view.controls.humanZoneOverride': "ការជំនួសតំបន់មនុស្ស",
  ...
  'view.organization.policy.hqStrict': "គោលការណ៍តឹងរឹងកណ្តាល",
  'view.organization.policy.dcCritical': "គោលការណ៍សំខាន់ DC",
...
const vi: Dict = {
  ...
  'view.devices.loadFailed': "Failed to load devices.",
  'view.settings.loadFailed': "Failed to load settings.",
  'aiChat.emptyState': 'Bắt đầu cuộc trò chuyện với KHOEM-AI',
  'aiChat.placeholder': 'Nhập lệnh hoặc câu hỏi…',
  'aiChat.subtitle': 'Trợ lý của bạn',
  'intl.pin': 'Ghim {name}',
  'intl.unpin': 'Bỏ ghim {name}',
  'navgroup.overview': 'Tổng quan',
  'navgroup.devicesControl': 'Thiết bị và điều khiển',
  'navgroup.securitySafety': 'An ninh và an toàn',
  'navgroup.organization': 'Tổ chức',
  'view.dashboard.subtitle': 'Tổng quan trực tiếp toàn bộ đội thiết bị KSV của bạn',
  'view.devices.subtitle': 'Quản lý mọi thiết bị đã kết nối',
  'view.controls.subtitle': 'Gửi và xem lệnh thiết bị',
  'view.protocols.subtitle': 'Kết nối và tình trạng giao thức',
  'view.gateway.subtitle': 'Gateway biên và chế độ ngoại tuyến',
  'view.security.subtitle': 'Danh tính, phiên và quyền truy cập',
  'view.safety.subtitle': 'Quy tắc an toàn và khóa liên động',
  'view.organization.subtitle': 'Địa điểm, nhóm và vai trò',
  'view.international.subtitle': 'Quốc gia, ngôn ngữ và múi giờ',
  'view.audit.subtitle': 'Nhật ký hoạt động và an ninh đầy đủ',
  'view.certificates.subtitle': 'Hồ sơ đào tạo và tuân thủ',
  'view.settings.subtitle': 'Tùy chọn tài khoản và nền tảng',
  'dashboard.trend.devicesUp': '2,4%',
  'dashboard.trend.rulesNew': '12 mới',
  'dashboard.trend.gatewayOffline': '1 ngoại tuyến',
  'dashboard.trend.countriesAdded': '3 đã thêm',
  'dashboard.traffic.title': 'Lưu lượng nền tảng',
  'dashboard.traffic.subtitle': 'Tin nhắn lệnh mỗi phút — 24 giờ qua',
  'dashboard.traffic.live': 'Trực tiếp',
  'dashboard.traffic.peakThroughput': 'Thông lượng đỉnh',
  'dashboard.traffic.cmdPerMin': '{count} lệnh/phút',
  'dashboard.traffic.avgLatency': 'Độ trễ trung bình',
  'dashboard.traffic.ms': '{count} ms',
  'dashboard.traffic.uptime': 'Thời gian hoạt động',
  'dashboard.traffic.days': '{count} ngày',
  'dashboard.health.title': 'Sức khỏe thiết bị',
  'dashboard.health.subtitle': 'Trạng thái đội thiết bị toàn cầu',
  'dashboard.health.online': 'Trực tuyến',
  'dashboard.health.warning': 'Cảnh báo',
  'dashboard.health.offline': 'Ngoại tuyến',
  'dashboard.alerts.title': 'Hoạt động cảnh báo',
  'dashboard.alerts.subtitle': 'Kích hoạt an toàn và an ninh',
  'dashboard.alerts.openAlerts': 'Cảnh báo đang mở',
  'dashboard.alerts.critical': '{count} nghiêm trọng',
  'dashboard.sites.title': 'Tải địa điểm',
  'dashboard.sites.subtitle': 'Thiết bị theo địa điểm và mức sử dụng gateway',
  'dashboard.sites.viewAll': 'Xem tất cả',
  'dashboard.sites.devicesAndLoad': '{count} thiết bị · {load}%',
  'dashboard.recentDevices.title': 'Thiết bị gần đây',
  'dashboard.safetyRules.title': 'Quy tắc an toàn',
  'dashboard.safetyRules.triggered': '{scope} · kích hoạt {count} lần',
  'dashboard.protocols.title': 'Tình trạng giao thức',
  'dashboard.protocols.devicesAndLatency': '{count} thiết bị · {latency}ms',
  'dashboard.gateway.title': 'Đội gateway biên',
  'dashboard.gateway.subtitle': 'Bộ điều khiển cục bộ có khả năng ngoại tuyến',
  'dashboard.gateway.onlineBadge': '{online}/{total} trực tuyến',
  'dashboard.gateway.cpu': 'CPU',
  'dashboard.gateway.mem': 'Bộ nhớ',
  'dashboard.gateway.devices': 'Thiết bị',
  'view.devices.registryTitle': 'Sổ đăng ký thiết bị',
  'view.devices.acrossAllSites': 'thiết bị trên mọi địa điểm',
  'view.devices.export': 'Xuất',
  'view.devices.searchPlaceholder': 'Tìm theo tên hoặc ID thiết bị…',
  'view.devices.noMatch': 'Không có thiết bị nào khớp với bộ lọc của bạn.',
  'view.devices.filter.all': 'tất cả',
  'view.devices.filter.online': 'trực tuyến',
  'view.devices.filter.warning': 'cảnh báo',
  'view.devices.filter.maintenance': 'bảo trì',
  'view.devices.filter.offline': 'ngoại tuyến',
  'view.devices.status.online': 'trực tuyến',
  'view.devices.status.warning': 'cảnh báo',
  'view.devices.status.offline': 'ngoại tuyến',
  'view.devices.status.maintenance': 'bảo trì',
  'view.devices.category.access': 'Truy cập',
  'view.devices.category.climate': 'Khí hậu',
  'view.devices.category.industrial': 'Công nghiệp',
  'view.devices.category.vehicle': 'Phương tiện',
  'view.devices.category.sensor': 'Cảm biến',
  'view.devices.category.network': 'Mạng',
  'view.devices.table.device': 'Thiết bị',
  'view.devices.table.category': 'Danh mục',
  'view.devices.table.protocol': 'Giao thức',
  'view.devices.table.location': 'Vị trí',
  'view.devices.table.signal': 'Tín hiệu',
  'view.devices.table.firmware': 'Phần mềm',
  'view.devices.table.status': 'Trạng thái',
  'view.audit.title': 'Nhật ký kiểm toán bất biến',
  'view.audit.subtitleText': 'Nhật ký sự kiện chuỗi mật mã — mọi hoạt động nền tảng',
  'view.audit.chainVerified': 'Chuỗi đã xác minh',
  'view.audit.searchPlaceholder': 'Tìm theo tác nhân, hành động hoặc mục tiêu…',
  'view.audit.noMatch': 'Không có sự kiện nào khớp với bộ lọc của bạn.',
  'view.audit.loading': 'Đang tải nhật ký kiểm toán…',
  'view.audit.loadFailed': 'Không thể tải nhật ký kiểm toán.',
  'view.audit.category.all': 'tất cả',
  'view.audit.category.auth': 'xác thực',
  'view.audit.category.device': 'thiết bị',
  'view.audit.category.safety': 'an toàn',
  'view.audit.category.admin': 'quản trị',
  'view.audit.category.network': 'mạng',
  'view.audit.result.success': 'thành công',
  'view.audit.result.denied': 'bị từ chối',
  'view.audit.result.error': 'lỗi',
  'view.certificates.heading': 'Chứng chỉ Sololearn',
  'view.certificates.description': 'Chứng nhận chuyên môn đã xác minh của các thành viên nhóm KSV',
  'view.certificates.certificatesLabel': 'Chứng chỉ',
  'view.certificates.verifiedLabel': 'Đã xác minh',
  'view.certificates.verified': 'Đã xác minh',
  'view.certificates.issued': 'Ngày cấp',
  'view.certificates.expires': 'Hết hạn',
  'view.certificates.viewCertificate': 'Xem chứng chỉ',
  'view.certificates.category.development': 'Phát triển',
  'view.certificates.category.security': 'Bảo mật',
  'view.certificates.category.iot': 'IoT',
  'view.certificates.category.database': 'Cơ sở dữ liệu',
  'view.certificates.category.cloud': 'Đám mây',
  'view.controls.vaultDoor.name': 'Cửa hầm phía Bắc',
  'view.controls.vaultDoor.site': 'Trụ sở Frankfurt',
  'view.controls.hvac.name': 'HVAC phòng sạch',
  'view.controls.hvac.site': 'Nhà máy Đài Bắc',
  'view.controls.pressEstop.name': 'Dừng khẩn cấp dây chuyền ép 7',
  'view.controls.pressEstop.site': 'Nhà máy Stuttgart',
  'view.controls.robotArm.name': 'Cánh tay robot RA-04',
  'view.controls.robotArm.site': 'Nhà máy Osaka',
  'view.controls.eastGate.name': 'Rào cổng Đông',
  'view.controls.eastGate.site': 'Logistics Dubai',
  'view.controls.coldStorage.name': 'Giám sát kho lạnh',
  'view.controls.coldStorage.site': 'Cảng Rotterdam',
  'view.controls.secured': 'ĐÃ KHÓA',
  'view.controls.unlocked': 'ĐÃ MỞ KHÓA',
  'view.controls.unlock': 'Mở khóa',
  'view.controls.lock': 'Khóa',
  'view.controls.setpoint': 'Điểm đặt',
  'view.controls.fan': 'Quạt',
  'view.controls.mode': 'Chế độ',
  'view.controls.cool': 'Làm mát',
  'view.controls.filter': 'Bộ lọc',
  'view.controls.estop': 'DỪNG KHẨN CẤP',
  'view.controls.lineHalted': 'DÂY CHUYỀN ĐÃ DỪNG',
  'view.controls.pressOperational': 'Máy ép hoạt động',
  'view.controls.reset': 'Đặt lại',
  'view.controls.speedLimit': 'Giới hạn tốc độ',
  'view.controls.humanZoneOverride': 'Ghi đè khu vực con người',
  'view.controls.active': 'Đang hoạt động',
  'view.controls.collisionDetection': 'Phát hiện va chạm',
  'view.controls.enabled': 'Đã bật',
  'view.controls.maintenance': 'Bảo trì',
  'view.controls.barrierOpen': 'RÀO ĐANG MỞ',
  'view.controls.barrierClosed': 'RÀO ĐANG ĐÓNG',
  'view.controls.close': 'Đóng',
  'view.controls.open': 'Mở',
  'view.controls.targetTemp': 'Nhiệt độ mục tiêu',
  'view.controls.current': 'Hiện tại',
  'view.controls.logTitle': 'Hoạt động điều khiển trực tiếp',
  'view.controls.logSubtitle': 'Lệnh đã gửi trong giờ qua',
  'view.controls.logLoading': 'Đang tải hoạt động gần đây…',
  'view.controls.logEmpty': 'Chưa gửi lệnh nào.',
  'view.controls.logLoadFailed': 'Không thể tải hoạt động gần đây.',
  'view.controls.log.vaultDoor': 'Cửa hầm phía Bắc',
  'view.controls.log.robotArm': 'Cánh tay robot RA-04',
  'view.controls.log.hvac': 'HVAC phòng sạch',
  'view.controls.log.pressLine': 'Dây chuyền ép 7',
  'view.controls.log.eastGate': 'Rào cổng Đông',
  'view.gateway.online': 'Trực tuyến',
  'view.gateway.degraded': 'Suy giảm',
  'view.gateway.offline': 'Ngoại tuyến',
  'view.gateway.memory': 'Bộ nhớ',
  'view.gateway.firmware': 'Phần mềm',
  'view.gateway.lastSync': 'Đồng bộ lần cuối',
  'view.gateway.offlineMode': 'Chế độ ngoại tuyến',
  'view.gateway.connected': 'Đã kết nối',
  'view.gateway.reconnecting': 'Đang kết nối lại',
  'view.gateway.discoveryTitle': 'Khám phá mạng cục bộ',
  'view.gateway.discoverySubtitle': 'Quét broadcast mDNS / UDP cho thiết bị biên',
  'view.gateway.discovery.frankfurt': 'Bộ điều khiển biên Frankfurt',
  'view.gateway.discovery.badgeReader': 'Đầu đọc thẻ B2-A',
  'view.gateway.discovery.singapore': 'Bộ điều khiển biên Singapore',
  'view.gateway.discovery.airSensor': 'Cảm biến không khí trên mái',
  'view.organization.hierarchyTitle': 'Cấu trúc tổ chức',
  'view.organization.hierarchySubtitle': 'Công ty → Địa điểm → Tòa nhà → Kế thừa chính sách thiết bị',
  'view.organization.nodes': 'nút',
  'view.organization.users': 'Người dùng',
  'view.organization.rules': 'quy tắc',
  'view.organization.accessPoliciesTitle': 'Chính sách truy cập',
  'view.organization.accessPoliciesSubtitle': 'Quy tắc kiểm soát truy cập dựa trên chính sách (PBAC)',
  'view.organization.roleDefinitionsTitle': 'Định nghĩa vai trò',
  'view.organization.roleDefinitionsSubtitle': 'Danh mục vai trò toàn nền tảng',
  'view.organization.type.company': 'Công ty mẹ',
  'view.organization.type.site': 'Khu vực/Địa điểm',
  'view.organization.type.building': 'Tòa nhà',
  'view.organization.type.floor': 'Tầng',
  'view.organization.site.frankfurt': 'Trụ sở Frankfurt',
  'view.organization.site.singapore': 'Trung tâm dữ liệu Singapore',
  'view.organization.site.taipei': 'Nhà máy Đài Bắc',
  'view.organization.site.emea': 'Khu vực EMEA',
  'view.organization.site.apac': 'Khu vực APAC',
  'view.organization.policy.hqStrict': 'Trụ sở nghiêm ngặt',
  'view.organization.policy.dcCritical': 'Trung tâm dữ liệu quan trọng',
  'view.organization.policy.fabCleanroom': 'Phòng sạch nhà máy',
  'view.organization.policy.emeaBaseline': 'Cơ sở EMEA',
  'view.organization.policy.apacBaseline': 'Cơ sở APAC',
  'view.organization.role.orgOwner': 'Chủ tổ chức',
  'view.organization.role.siteAdmin': 'Quản trị địa điểm',
  'view.organization.role.safetyEngineer': 'Kỹ sư an toàn',
  'view.organization.role.networkAdmin': 'Quản trị mạng',
  'view.organization.role.operator': 'Nhà vận hành',
  'view.organization.role.viewer': 'Người xem',
  'view.organization.perms.orgOwner': 'Kiểm soát toàn nền tảng',
  'view.organization.perms.siteAdmin': 'Quản lý cấp địa điểm',
  'view.organization.perms.safetyEngineer': 'Quy tắc an toàn + điều khiển thiết bị',
  'view.organization.perms.networkAdmin': 'Cấu hình gateway + giao thức',
  'view.organization.perms.operator': 'Điều khiển thiết bị + xem kiểm toán',
  'view.organization.perms.viewer': 'Truy cập bảng điều khiển chỉ đọc',
  'view.protocols.abstractionTitle': 'Lớp trừu tượng giao thức',
  'view.protocols.abstractionSubtitle': 'Giao diện adapter thống nhất cho mọi giao thức truyền tải',
  'view.protocols.latency': 'Độ trễ',
  'view.protocols.encryptionTitle': 'Tiêu chuẩn mã hóa',
  'view.protocols.capabilityRegistryTitle': 'Sổ đăng ký khả năng',
  'view.protocols.dev': 'phát triển',
  'view.protocols.status.active': 'hoạt động',
  'view.protocols.status.degraded': 'suy giảm',
  'view.protocols.status.offline': 'ngoại tuyến',
  'view.protocols.enc.tls': 'TLS 1.3',
  'view.protocols.enc.wpa3': 'WPA3-Enterprise',
  'view.protocols.enc.aesBle': 'AES-CCM (BLE)',
  'view.protocols.enc.aesZigbee': 'AES-128 (Zigbee)',
  'view.safety.stat.rulesActive': 'Quy tắc đang hoạt động',
  'view.safety.stat.totalTriggers': 'Tổng kích hoạt (30 ngày)',
  'view.safety.stat.criticalRules': 'Quy tắc nghiêm trọng',
  'view.safety.scope.all': 'Mọi phạm vi',
  'view.safety.scope.door': 'Cửa',
  'view.safety.scope.vehicle': 'Phương tiện',
  'view.safety.scope.industrial': 'Công nghiệp',
  'view.safety.condition': 'Điều kiện',
  'view.safety.action': 'Hành động',
  'view.safety.triggered': 'Kích hoạt {count} lần',
  'view.safety.active': 'Đang hoạt động',
  'view.safety.disabled': 'Đã tắt',
  'view.safety.severity.critical': 'nghiêm trọng',
  'view.safety.severity.high': 'cao',
  'view.safety.severity.medium': 'trung bình',
  'view.safety.severity.low': 'thấp',
  'view.security.stat.grade': 'Điểm bảo mật',
  'view.security.stat.activeSessions': 'Phiên đang hoạt động',
  'view.security.stat.mfaCoverage': 'Độ phủ MFA',
  'view.security.stat.deniedAttempts': 'Lần bị từ chối (24h)',
  'view.security.sessions.title': 'Phiên đang hoạt động',
  'view.security.sessions.subtitle': 'Phiên người dùng đã xác thực trên nền tảng',
  'view.security.table.user': 'Người dùng',
  'view.security.table.method': 'Phương thức',
  'view.security.table.location': 'Vị trí',
  'view.security.table.mfa': 'MFA',
  'view.security.table.lastActive': 'Hoạt động cuối',
  'view.security.table.status': 'Trạng thái',
  'view.security.mfa.on': 'Bật',
  'view.security.mfa.off': 'Tắt',
  'view.security.authMethods.title': 'Phương thức xác thực',
  'view.security.authMethods.sessions': 'phiên',
  'view.security.policies.title': 'Chính sách bảo mật',
  'view.security.policy.zeroPlaintext': 'Chính sách mật khẩu không văn bản thuần',
  'view.security.policy.oauthOidc': 'Luồng OAuth 2.0 / OIDC',
  'view.security.policy.otpRecovery': 'Sao lưu khôi phục OTP',
  'view.security.policy.sessionAudit': 'Ghi nhật ký kiểm toán phiên',
  'view.security.policy.forceMfaAdmins': 'Buộc MFA cho mọi quản trị viên',
  'view.security.policy.ipAllowlist': 'Danh sách IP cho phép (sản xuất)',
  'view.security.status.enforced': 'Đã áp dụng',
  'view.security.status.partial': 'Một phần',
  'view.settings.platform.title': 'Nền tảng',
  'view.settings.platform.subtitle': 'Hành vi cốt lõi nền tảng',
  'view.settings.autoUpdate.label': 'Cập nhật phần mềm tự động',
  'view.settings.autoUpdate.desc': 'Đẩy bản cập nhật OTA đến thiết bị đủ điều kiện',
  'view.settings.offlineMode.label': 'Chế độ ngoại tuyến biên',
  'view.settings.offlineMode.desc': 'Cho phép gateway hoạt động không cần đám mây',
  'view.settings.auditLog.label': 'Ghi nhật ký kiểm toán bất biến',
  'view.settings.auditLog.desc': 'Chuỗi mật mã tất cả sự kiện',
  'view.settings.security.title': 'Bảo mật',
  'view.settings.security.subtitle': 'Chính sách xác thực và truy cập',
  'view.settings.twoFactor.label': 'Yêu cầu 2FA cho mọi quản trị viên',
  'view.settings.twoFactor.desc': 'Áp dụng MFA cho vai trò quản trị viên và nhà vận hành',
  'view.settings.zeroPlaintext.label': 'Chính sách mật khẩu không văn bản thuần',
  'view.settings.zeroPlaintext.desc': 'Băm Argon2id, không lưu văn bản thuần',
  'view.settings.safetyOverride.label': 'Cho phép ghi đè quy tắc an toàn',
  'view.settings.safetyOverride.desc': 'Cho phép kỹ sư tạm thời vô hiệu hóa quy tắc',
  'view.settings.notifications.title': 'Thông báo',
  'view.settings.notifications.subtitle': 'Kênh phân phối cảnh báo',
  'view.settings.emailAlerts.label': 'Cảnh báo email',
  'view.settings.emailAlerts.desc': 'Gửi cảnh báo nghiêm trọng đến email quản trị viên',
  'view.settings.smsAlerts.label': 'Cảnh báo SMS',
  'view.settings.smsAlerts.desc': 'Gửi cảnh báo nghiêm trọng qua gateway SMS',
  'view.settings.localization.title': 'Bản địa hóa và dữ liệu',
  'view.settings.localization.subtitle': 'Tùy chọn ngôn ngữ và lưu trữ',
  'view.settings.defaultLanguage': 'Ngôn ngữ mặc định',
  'view.settings.defaultTimezone': 'Múi giờ mặc định',
  'view.settings.timezoneAuto': 'Tự động (phát hiện từ trình duyệt)',
  'view.settings.databaseBackup': 'Sao lưu cơ sở dữ liệu',
  'view.settings.backupInterval': 'Tự động · mỗi {hours}h',
  'view.settings.saveBar.note': 'Thay đổi áp dụng cho mọi địa điểm và gateway.',
  'view.settings.saveBar.save': 'Lưu thay đổi',
};
